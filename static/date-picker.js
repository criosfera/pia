...
function AddDatePickers() {
    ...
    window.MonthsShort = ['Jan', 'Feb', 'Mar', 'Abr', 'May', 'Jun', 'Jul', 'Ago', 'Sep', 'Oct', 'Nov', 'Dic'];
...
function AddCalendarDays(Year, Month, Object) {
    ...
    var MainContent = "<table><tr><td>Domingo</td><td>Lunes</td><td>Martes</td><td>Miercoles</td><td>Jueves</td><td>Viernes</td><td>Sabado</td></tr>";
